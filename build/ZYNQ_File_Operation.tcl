...
#
# ZYNQ_File_Operation.tcl: Tcl script for re-creating project 'Triple_ZYBO'
#
# Generated by Vivado on Thu Mar 28 19:03:27 CDT 2019
...
#
# 1. This project restoration tcl script (ZYNQ_File_Operation.tcl) that was generated.
#
...
set _xil_proj_name_ "ZYNQ_File_Operation"
...
set script_file "ZYNQ_File_Operation.tcl"
...
set files [list \
 [file normalize "${origin_dir}/../rtl/ZYNQ_File_Operation_wrapper.v"]\
]
...
set obj [get_filesets sources_1]
set_property -name "top" -value "ZYNQ_File_Operation" -objects $obj
...
set file "[file normalize ${origin_dir}/../gen/xdc/Constraints_File.xdc]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "xdc/Constraints_File.xdc"
...
# Proc to create BD ZYNQ_File_Operation
proc cr_bd_ZYNQ_File_Operation { parentCell } {
...
# End of cr_bd_ZYNQ_File_Operation()
cr_bd_ZYNQ_File_Operation ""
set_property IS_MANAGED "0" [get_files ZYNQ_File_Operation.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files ZYNQ_File_Operation.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files ZYNQ_File_Operation.bd ] 
