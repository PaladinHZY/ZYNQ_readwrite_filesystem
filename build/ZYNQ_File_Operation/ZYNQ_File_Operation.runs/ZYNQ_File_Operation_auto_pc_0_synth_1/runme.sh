...
HD_PWD='/home/zhenyu/FPGA/ZYNQGit/File_WRRD/build/ZYNQ_File_Operation/ZYNQ_File_Operation.runs/ZYNQ_File_Operation_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ZYNQ_File_Operation_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ZYNQ_File_Operation_auto_pc_0.tcl
