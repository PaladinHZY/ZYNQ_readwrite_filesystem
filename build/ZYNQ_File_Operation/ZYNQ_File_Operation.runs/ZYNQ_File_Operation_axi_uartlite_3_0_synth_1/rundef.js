...
ISEStep( "vivado",
         "-log ZYNQ_File_Operation_axi_uartlite_3_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ZYNQ_File_Operation_axi_uartlite_3_0.tcl" );
