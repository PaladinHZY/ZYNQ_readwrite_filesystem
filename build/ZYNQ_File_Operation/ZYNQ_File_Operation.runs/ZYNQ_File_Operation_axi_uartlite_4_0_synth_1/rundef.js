...
ISEStep( "vivado",
         "-log ZYNQ_File_Operation_axi_uartlite_4_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ZYNQ_File_Operation_axi_uartlite_4_0.tcl" );
