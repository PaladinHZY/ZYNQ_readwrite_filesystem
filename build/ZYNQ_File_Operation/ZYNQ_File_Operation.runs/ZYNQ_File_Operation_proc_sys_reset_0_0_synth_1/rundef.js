...
ISEStep( "vivado",
         "-log ZYNQ_File_Operation_proc_sys_reset_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ZYNQ_File_Operation_proc_sys_reset_0_0.tcl" );
