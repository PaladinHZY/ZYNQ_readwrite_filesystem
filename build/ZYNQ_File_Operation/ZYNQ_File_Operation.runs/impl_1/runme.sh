...
HD_PWD='/home/zhenyu/FPGA/ZYNQGit/File_WRRD/build/ZYNQ_File_Operation/ZYNQ_File_Operation.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ZYNQ_File_Operation.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ZYNQ_File_Operation.tcl -notrace
