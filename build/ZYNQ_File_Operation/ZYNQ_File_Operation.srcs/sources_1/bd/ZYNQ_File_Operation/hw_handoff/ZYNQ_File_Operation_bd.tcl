...
################################################################
# This is a generated script based on design: ZYNQ_File_Operation
#
...
# source ZYNQ_File_Operation_script.tcl
...
set design_name ZYNQ_File_Operation
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins axi_uartlite_2/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M03_AXI [get_bd_intf_pins axi_uartlite_3/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M03_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M04_AXI [get_bd_intf_pins axi_uartlite_4/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M04_AXI]
  ...
  connect_bd_net -net axi_uartlite_2_tx [get_bd_ports tx_2] [get_bd_pins axi_uartlite_2/tx]
  connect_bd_net -net axi_uartlite_3_tx [get_bd_ports tx_3] [get_bd_pins axi_uartlite_3/tx]
  connect_bd_net -net axi_uartlite_4_tx [get_bd_ports tx_4] [get_bd_pins axi_uartlite_4/tx]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins axi_uartlite_1/s_axi_aresetn] [get_bd_pins axi_uartlite_2/s_axi_aresetn] [get_bd_pins axi_uartlite_3/s_axi_aresetn] [get_bd_pins axi_uartlite_4/s_axi_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins axi_uartlite_1/s_axi_aclk] [get_bd_pins axi_uartlite_2/s_axi_aclk] [get_bd_pins axi_uartlite_3/s_axi_aclk] [get_bd_pins axi_uartlite_4/s_axi_aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N]
  connect_bd_net -net rx_1 [get_bd_ports rx_0] [get_bd_pins axi_uartlite_0/rx]
  ...
  connect_bd_net -net rx_3_1 [get_bd_ports rx_3] [get_bd_pins axi_uartlite_3/rx]
  connect_bd_net -net rx_4_1 [get_bd_ports rx_4] [get_bd_pins axi_uartlite_4/rx]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x42C30000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_uartlite_3/S_AXI/Reg] SEG_axi_uartlite_3_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x42C40000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_uartlite_4/S_AXI/Reg] SEG_axi_uartlite_4_Reg
